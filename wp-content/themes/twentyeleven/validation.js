$(document).ready(function(){
	...
	form.submit(function(){
		if(validateEmail1() && validateEmail2())// && validatePass1() && validatePass2() && validateNamet() && validateSurname() && validateAddress() && validateCity() && validateCheck())
			return true
		else
			return false;
	});
	...
	function validatePass2(){
		...
		if(pass2.val().length < 1){
			...
			pass2.addClass("error");
			pass2Info.text("Wpisane adresy e-mail nie zgadzają się");
			pass2Info.addClass("error");
			return false;
		}
		//if it's valid
