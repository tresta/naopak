...
function fileQueueError(file, errorCode, message) {
	try {
		...
		addImage("http://naopak.com.pl/wp-content/themes/twentyeleven/images/" + imageName);
...
function uploadSuccess(file, serverData) {
	try {
		...
		if (serverData.substring(0, 7) === "FILEID:") {
			addImage("http://naopak.com.pl/wp-content/themes/twentyeleven/thumbnail.php?id=" + serverData.substring(7));

			progress.setStatus("Upload Complete.");
			progress.toggleCancel(false);
		} else {
			addImage("http://naopak.com.pl/wp-content/themes/twentyeleven/images/error.gif");
...
function uploadError(file, errorCode, message) {
	...
	try {
		...
		case SWFUpload.UPLOAD_ERROR.UPLOAD_LIMIT_EXCEEDED:
			imageName = "http://naopak.com.pl/wp-content/themes/twentyeleven/images/uploadlimit.gif";
			break;
		default:
			alert(message);
			break;
