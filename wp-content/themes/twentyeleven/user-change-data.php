...
/**
 ...
 Template Name: user-change-data
...
?>
    ...
    <div class="formclear"></div>
    <div>
	<input id="submit" type="submit" name="submit" value="Aktualizuj dane" style="width:115px;" /> <input id="send" type="reset" name="anuluj" value="Anuluj" style="width:115px;" />
</div>
	</form>
    </div> 
